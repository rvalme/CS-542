...
class DaoRecipe():
    ...
    def __process_recipe_info(recipe_tuple, recipe_instance):
        ...
        for i in range(2, len(recipe_tuple) - 1):
            recipe_string_to_int.append(recipe_tuple[i])
        ...
        recipe_instance.calories = recipe_string_to_int[4]
        recipe_instance.fat = recipe_string_to_int[2]
        recipe_instance.protein = recipe_string_to_int[3]
        recipe_instance.sodium = recipe_string_to_int[5]
        recipe_instance.sugar = recipe_string_to_int[1]
        recipe_instance.carbs = recipe_string_to_int[0]
